...
Tags: jsDelivr, cdn, jquery, jquery-migrate, jquery-masonry, js, optimisation, speed, WordPress Performance
Donate link: additifstabac@free.fr
Requires at least: 3.9
Tested up to: 4.0
Stable tag: 1.1

Loads the open source scripts jQuery, jQuery-migrate and jQuerymasonry from jsDelivr\'s CDN .
...
Ce CDN utilise la puissance des CDN de CloudFlare et de MAXCDN. 
MAXCDN est membre de Platine de la fondation jQuery dont WordPress est membre fondateur. 
...
These CDN uses the power of the CDN of CloudFlare and of MAXCDN.
MAXCDN Platinum is a member of the jQuery foundation that WordPress is a founding member.
...
It automatically detects the version of the script used by your theme and makes a request to the latter on the CDN jsDelivr.
